...
<p>We received your payment<?php if ( $amount ) echo ' (' . esc_html( $currency . ' ' . $amount ) . ')'; ?>. This amount covers both the scan &amp; your first year, and the Matterport activation fee.</p>
