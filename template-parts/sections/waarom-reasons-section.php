...
$reasons = [
    [
        ...
        'description' => 'Herinneringen leven niet alleen in foto\'s of verhalen. Ze leven ook in ruimtes. Soms hoef je maar een gang, een deur of een bepaalde lichtinval terug te zien om meteen weer iets te voelen. Een gewone foto toont een moment. Een virtuele tour bewaart een plek.',
    ],
    [
    ...
    [
        ...
        'description' => 'Wat vandaag vertrouwd voelt, wordt later vaak kostbaar. Een woning digitaal bewaren is een geschenk aan je toekomstige zelf. En soms ook aan je kinderen, familie of geliefden. Wat vandaag vanzelfsprekend lijkt, kan later onbetaalbaar aanvoelen.',
    ],
];
?>
    ...
    <div class="w-[90vw] mx-auto py-16 md:py-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-[2vw] animate-stagger-parent">
            <?php foreach ($reasons as $reason) : ?>
                <div class="animate-stagger-child reason-card bg-white/70 rounded-[2.604vw] p-8 md:p-[2vw]">
