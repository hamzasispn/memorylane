    ...
    <div class="w-[90vw] mx-auto py-16 md:py-24">
        ...
        <div class="section-header text-center mb-10 md:mb-[2.5vw]">
            ...
            <p class="text-primary text-[4vw] md:text-[1.25vw] text-center w-full md:w-[55%] mx-auto leading-[1.8]">
                Transparant en eenvoudig — zo houden wij het graag.
            </p>
        </div>
        ...
        <!-- Cancellation notice -->
        <div class="w-full md:w-[70%] mx-auto rounded-[2.604vw] bg-white py-5 md:py-[1.563vw] px-8 md:px-[4vw] mt-6 md:mt-[1.563vw] animate-fade-up">
            <div class="flex items-center justify-center gap-4">
                <img src="<?= get_template_directory_uri(); ?>/assets/star-icon.png" alt="" class="!w-12 !h-12 md:!w-[2.5vw] md:!h-[2.5vw] object-contain flex-shrink-0">
                <h4 class="text-primary font-primary text-[5.5vw] md:text-[1.8vw] leading-[1.3]">Abonnement maandelijks opzegbaar</h4>
            </div>
